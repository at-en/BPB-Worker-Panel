...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = '💦 Atcn - WorkerLess ⭐'
...
const renderHomePage = async (env, hostName, fragConfigs) => {
	...
	<body>
		<h1>Atcn Panel <span style="font-size: smaller;">${panelVersion}</span> 💦</h1>
		<div class="form-container">
            ...
            <div class="footer">
                ...
                <a class="link" href="https://blog.atcn.cc" target="_blank">Atcn</a>
